...
- On the quiz screen, use the dropdown aligned against each HP code to select the definition you think matches it. Each dropdown shows 6 options with one correct and five incorrect.
